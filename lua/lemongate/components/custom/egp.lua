...
if $EGP:ValidEGP( value %1 ) then //and %IsOwner( %context.Player, value %1 ) then
	print( "EGP BOX" )
	local %Bool, %Obj = EGP:CreateObject( value %1, EGP.Objects.Names["Box"], { index = value %2, w = value %3.x, h = value %3.y, x = value %4.x, y = value %4.y }, %context.Player )
    if %Bool then
		print( "YEP" )
...
if $EGP:ValidEGP( value %1 ) then //and %IsOwner( %context.Player, value %1 ) then
	local %Bool, %Obj = EGP:CreateObject( value %1, EGP.Objects.Names["BoxOutline"], { index = value %2, w = value %3.x, h = value %3.y, x = value %4.x, y = value %4.y }, %context.Player )
    if %Bool then
		API.EGPAction( value %1, %context, "SendObject", %Obj )
		%data.EGP[value %1] = true
	end
...
if $EGP:ValidEGP( value %1 ) then //and %IsOwner( %context.Player, value %1 ) then
	local %Bool, %Obj = EGP:CreateObject( value %1, EGP.Objects.Names["RoundedBox"], { index = value %2, w = value %3.x, h = value %3.y, x = value %4.x, y = value %4.y }, %context.Player )
    if %Bool then
		API.EGPAction( value %1, %context, "SendObject", %Obj )
		%data.EGP[value %1] = true
	end
...
if $EGP:ValidEGP( value %1 ) then //and %IsOwner( %context.Player, value %1 ) then
	local %Bool, %Obj = EGP:CreateObject( value %1, EGP.Objects.Names["RoundedBoxOutline"], { index = value %2, w = value %3.x, h = value %3.y, x = value %4.x, y = value %4.y }, %context.Player )
    if %Bool then
		API.EGPAction( value %1, %context, "SendObject", %Obj )
		%data.EGP[value %1] = true
	end
