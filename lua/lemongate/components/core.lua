...
Core:AddFunction( "cpuTime", "", "n", "%context.CPU_Tick" )

-- Returns the amount of cpu time used on average in microseconds
Core:AddFunction( "cpuAverage", "", "n", "%context.CPU_Average" )

-- Returns the size of the tick quota in microseconds
Core:AddFunction( "tickQuota", "", "n", "$GetConVarNumber(\"lemongate_tick_quota\", 0)" )

-- Returns the size of the soft quota in microseconds
Core:AddFunction( "softQuota", "", "n", "$GetConVarNumber(\"lemongate_soft_quota\", 0)" )

-- Returns the size of the hard quota in microseconds
Core:AddFunction( "hardQuota", "", "n", "$GetConVarNumber(\"lemongate_hard_quota\", 0)" )

Core:AddFunction( "quota", "", "n", "%context.Quota_Tick" )

Core:AddFunction( "quotaAverage", "", "n", "%context.Quota_Average" )
