...
function Compiler:GetValue( RootTrace )
	...
	elseif self:AcceptToken( "var" ) then
		...
		if self:AcceptToken( "inc" ) then
			Value = self:Compile_INCREMENT( Trace, Variable )
		elseif self:AcceptToken( "dec" ) then
			Value = self:Compile_DECREMENT( Trace, Variable )
		else
...
function Compiler:Statement( RootTrace )
	...
	return self:StatmentError( ) --self:NextStatement( RootTrace )
end
...
function Compiler:Statment_VAR( RootTrace )
	...
	-- Inc / Dec
	if self:AcceptToken( "inc" ) then
		return self:Compile_INCREMENT( Trace, Variable )
	elseif self:AcceptToken( "dec" ) then
		return self:Compile_DECREMENT( Trace, Variable )
