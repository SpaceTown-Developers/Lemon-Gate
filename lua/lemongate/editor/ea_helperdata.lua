...
/*---------------------------------------------------------------------------
	...
	Documented functions: 401
	Documented events: 0
	
	Undocumented functions: 117
	Undocumented events: 12
	
	Generated at: 07/24/13 17:48:02
---------------------------------------------------------------------------*/
...
// L
Data["loadFromDupe<p>"] = "Called when the LemonGate is pasted. Will not be called if no buffer is saved."
...
// R
Data["receiveBuffer<sep>"] = "Called when the LemonGate receives a buffer. (string) is message and (entity) is sender. "

// S
Data["saveToDupe< p>"] = "Called when advanced duplicating a LemonGate, return a buffer to store data to the duplication."
...
Data["buffer( p)"] = "Creates a new buffer."
...
Data["readAngle(p: a)"] = "Reads the next angle on the buffer."
Data["readArray(xwl:nn t)"] = ""
Data["readCell(xwl:n n)"] = "Reads from high speed memory on the linked component."
Data["readEntity(p: e)"] = "Reads the next entity on the buffer."
Data["readNumber(p: n)"] = "Reads the next number on the buffer."
Data["readPos(p n)"] = ""
Data["readString(p: s)"] = "Reads the next string on the buffer."
Data["readVector(p: v)"] = "Reads the next vector on the buffer."
...
Data["send(p:se)"] = "Calls the 'receiveBuffer' event on (entity) using (string) as message."
...
// W
Data["writeAngle(p:a)"] = "Writes an angel to the buffer."
Data["writeCell(xwl:nn b)"] = "Writes to high speed memory on the linked component."
Data["writeEntity(p:e)"] = "Writes an entity to the buffer."
Data["writeNumber(p:n)"] = "Writes a number to the buffer."
Data["writePos(p n)"] = ""
Data["writeString(p:s)"] = "Writes a string to the buffer. "
...
Data["writeVector(p:v)"] = "Writes a vector to the buffer."
