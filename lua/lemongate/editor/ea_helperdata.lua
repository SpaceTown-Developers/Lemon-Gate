...
/*---------------------------------------------------------------------------
	...
	Undocumented functions: 152
	Undocumented events: 4
	
	Generated at: 08/14/13 09:32:56
---------------------------------------------------------------------------*/
...
Data["applyOffsetForce(e:vv)"] = "Applies an offset vector force to an entity."
Data["applyOffsetForce(p:vv)"] = "Applies an offset vector force to a physics object."
...
Data["ceil(an a)"] = "Rounds the components of (angle PYR) up to (number)'s decimal precision."
...
Data["endPos(xtr:v)"] = "Returns the end position of a trace."
...
Data["entity(xwl: e)"] = "Returns the entity of a wirelink."
...
Data["explodePattern(s:s t)"] = "Explodes a string into a table using a string pattern."
...
Data["hitGrate(xtr:b)"] = "Trace Mask: "
...
Data["hitSlime(xtr:b)"] = "Trace Mask: "
Data["hitSolid(xtr:b)"] = "Trace Mask: "
...
Data["inrange(xv2xv2xv2 b)"] = "Returns true if (vector2 value) is between (vector2 min) and (vector2 max)."
...
Data["insert(t:nq)"] = "Inserts (quaternion) to entry (number) of a table."
...
Data["insert(t:nxbf)"] = "Inserts (buffer) to the bottom of a table."
...
Data["intersectRayWithOBB(vvvavv v)"] = ""
Data["intersectRayWithPlane(vvvv v)"] = ""
...
Data["parent(h:h)"] = "Sets the parent of a hologram."
Data["parent(h:p)"] = "Sets the parent of a hologram."
...
Data["qRotation(vn q)"] = "Returns a quaternion from a vector, number controls the angle."
...
Data["quat(nnnn q)"] = "Creates a quaternion nR nI nJ nK."
Data["quat(v q)"] = "Converts (vector) to a quaternion."
Data["quat(vv q)"] = "Creates a quaternion using (vector forward) and (vector up)."
...
Data["rotateAroundAxis(a:vn a)"] = "Rotates an angle around (vector axis) by (number degrees)."
...
Data["round(an a)"] = "Round angle PYR components to (number)'s decimal precision."
...
Data["slerp(qqn q)"] = "Interpolates between two quaternions by a ratio of the given number."
...
Data["type(q s)"] = "A usless function that ways returns \"quatrion\""
...
Data["type(xbf s)"] = "A usless function that ways returns \"buffer\""
...
Data["writePos(xbf n)"] = "Returns the current write index of a buffer."
