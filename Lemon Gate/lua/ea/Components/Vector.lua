...
/*==============================================================================================
	Wire Links
==============================================================================================*/
E_A:RegisterOperator("get", "wlsv", "v", function(self, ValueA, ValueB)
...
E_A:RegisterOperator("set", "wlsv", "", function(self, ValueA, ValueB, ValueC)
	local Entity, Index, Value = ValueA(self), ValueB(self), ValueC(self)
	if !Entity or !Entity:IsValid() or !Entity.Outputs then return 0 end
	
	WireLib.TriggerInput(Entity, Index, Vector(Value[1], Value[2], Value[3]))
end)
