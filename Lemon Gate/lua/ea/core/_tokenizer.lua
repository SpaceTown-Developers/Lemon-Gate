...
==============================================================================================*/
local Tokens, OpTokens, WordTokens = { }, { }, { }
...
function E_A:CreateOpToken(Patern, Tag,  Name)
	...
	Tokens[Name] = Token; OpTokens[#OpTokens + 1] = Token
end

function E_A:CreateWordToken(Patern, Tag,  Name)
	CheckType(Patern, "string", 1); CheckType(Tag, "string", 2); CheckType(Name, "string", 3)
	-- Purpose: Create a new token.
		
	local Token = {Patern, Tag, Name or "Unknown Token"}
	Tokens[Name] = Token; WordTokens[#WordTokens + 1] = Token
end
...
-- Keyword Tokens
E_A:CreateWordToken("if", "if", "if")
E_A:CreateWordToken("elseif", "eif", "else if")
E_A:CreateWordToken("else", "els", "else")
E_A:CreateWordToken("while", "whl", "while")
E_A:CreateWordToken("for", "for", "for")
E_A:CreateWordToken("foreach", "each", "foreach")
E_A:CreateWordToken("function", "func", "function constructor")
E_A:CreateWordToken("switch", "swh", "switch")
E_A:CreateWordToken("event", "evt", "event constructor")
E_A:CreateWordToken("try", "try", "try")
E_A:CreateWordToken("catch", "cth", "catch")

-- Sub KeyWords
E_A:CreateTCreateWordTokenoken("break", "brk", "break")
E_A:CreateWordToken("continue", "cnt", "continue")
E_A:CreateWordToken("return", "ret", "return")
E_A:CreateWordToken("error", "err", "error")

-- Decleration KeyWords
E_A:CreateWordToken("global", "glob", "global")
E_A:CreateWordToken("input", "in", "input")
E_A:CreateWordToken("output", "out", "output")
E_A:CreateWordToken("persist", "per", "persist")
